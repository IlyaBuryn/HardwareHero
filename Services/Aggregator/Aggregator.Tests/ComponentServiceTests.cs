...
namespace Aggregator.Tests
{
    public class ComponentServiceTests
    {
        ...
        //{
        //    // Arrange
        //    var mockComponentRepo = new Mock<ICollectionRepositoryAsync<Component>>();
        //    var mockComponentReviewRepo = new Mock<ICollectionRepositoryAsync<ComponentLocalReview>>();
        ...
        //{
        //    new ComponentLocalReview { ComponentId = componentId, Recommended = true },
        //    new ComponentLocalReview { ComponentId = componentId, Recommended = true },
        //    new ComponentLocalReview { ComponentId = componentId, Recommended = false }
        //};

        //    mockComponentRepo.Setup(repo => repo.GetOneEntityAsync(It.IsAny<Expression<Func<Component, bool>>>()))
        //        .ReturnsAsync(component);
        //    mockComponentReviewRepo.Setup(repo => repo.GetManyEntitiesAsync(It.IsAny<Expression<Func<ComponentLocalReview, bool>>>()))
        ...
        //        .ReturnsAsync(component);
        //    mockComponentReviewRepo.Setup(repo => repo.GetManyEntitiesAsync(It.IsAny<Expression<Func<ComponentLocalReview, bool>>>()))
        //        .ReturnsAsync(Enumerable.Empty<ComponentLocalReview>().AsQueryable());
