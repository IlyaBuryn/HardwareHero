...
namespace Storage.Api.Extensions
{
    public static class ServiceCollectionExtensions
    {
            ...
            this IServiceCollection services, WebApplicationBuilder builder)
        {
            ...
            services
                .AddKafkaReplyService<UploadFileEvent, ReturnFileUrlEvent>(messageConfig)
                .AddKafkaReplyService<ChangeFileEvent, ReturnFileUrlEvent>(messageConfig)
                .AddKafkaReplyService<DeleteFileEvent, DeleteFileResultEvent>(messageConfig);
        ...
        {
            services
                .AddHostedService<FileEventsHandler>();
